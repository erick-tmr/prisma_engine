...
- `deploy/seed-prod-catalog.sh` — one-off: upload the initial catalog + hero banner images to the prod R2 bucket via an SSH tunnel to the prod DB. Runbook: `docs/seeding-images.md`. Catalog images are gitignored, not committed.
