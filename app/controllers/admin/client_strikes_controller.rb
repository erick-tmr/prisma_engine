module Admin
  class ClientStrikesController < BaseController
    def destroy
      ...
      Questions::Moderate.call(question: strike.question, event: "release", actor: current_user)
      ...
      redirect_to admin_client_path(client), notice: t("admin.clients.detail.strikes.removed")
    end
  end
end
