...
ActiveRecord::Schema[8.1].define(version: 2026_09_25_200000) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.check_constraint "char_length(observation) <= 1400", name: "orders_observation_length"
  end
  ...
  create_table "shipments", force: :cascade do |t|
    ...
    t.string "receiver_obs", limit: 100
    ...
    t.integer "width_cm"
    t.string "zip"
    t.index ["order_id", "direction"], name: "index_shipments_on_order_id_and_direction_current", unique: true, where: "(superseded_at IS NULL)"
